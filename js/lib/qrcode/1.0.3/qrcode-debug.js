define("lib/qrcode/1.0.3/qrcode-debug", [ "$-debug", "./qrcodealg-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
...
define("lib/qrcode/1.0.3/qrcodealg-debug", [], function(require, exports, module) {
    /**
	 * 二维码算法实现
