define("lib/autocomplete/1.2.3/textarea-complete-debug", [ "$-debug", "gallery/selection/0.9.0/selection-debug", "./autocomplete-debug", "lib/overlay/1.1.1/overlay-debug", "lib/position/1.0.1/position-debug", "lib/iframe-shim/1.0.2/iframe-shim-debug", "lib/widget/1.1.1/widget-debug", "lib/base/1.1.1/base-debug", "lib/class/1.1.0/class-debug", "lib/events/1.1.0/events-debug", "lib/templatable/0.9.1/templatable-debug", "gallery/handlebars/1.0.2/handlebars-debug", "./data-source-debug", "./filter-debug", "./autocomplete-debug.handlebars" ], function(require, exports, module) {
    var $ = require("$-debug");
...
define("lib/autocomplete/1.2.3/autocomplete-debug", [ "$-debug", "lib/overlay/1.1.1/overlay-debug", "lib/position/1.0.1/position-debug", "lib/iframe-shim/1.0.2/iframe-shim-debug", "lib/widget/1.1.1/widget-debug", "lib/base/1.1.1/base-debug", "lib/class/1.1.0/class-debug", "lib/events/1.1.0/events-debug", "lib/templatable/0.9.1/templatable-debug", "gallery/handlebars/1.0.2/handlebars-debug", "lib/autocomplete/1.2.3/data-source-debug", "lib/autocomplete/1.2.3/filter-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    var Overlay = require("lib/overlay/1.1.1/overlay-debug");
    var Templatable = require("lib/templatable/0.9.1/templatable-debug");
    var DataSource = require("lib/autocomplete/1.2.3/data-source-debug");
    var Filter = require("lib/autocomplete/1.2.3/filter-debug");
    var template = require("lib/autocomplete/1.2.3/autocomplete-debug.handlebars");
...
define("lib/autocomplete/1.2.3/data-source-debug", [ "lib/base/1.1.1/base-debug", "lib/class/1.1.0/class-debug", "lib/events/1.1.0/events-debug", "$-debug" ], function(require, exports, module) {
...
define("lib/autocomplete/1.2.3/filter-debug", [ "$-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    var Filter = {
...
define("lib/autocomplete/1.2.3/autocomplete-debug.handlebars", [ "gallery/handlebars/1.0.2/runtime-debug" ], function(require, exports, module) {
