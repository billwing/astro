define("lib/dialog/1.2.5/confirmbox-debug", [ "$-debug", "./dialog-debug", "lib/overlay/1.1.4/overlay-debug", "lib/position/1.0.1/position-debug", "lib/iframe-shim/1.0.2/iframe-shim-debug", "lib/widget/1.1.1/widget-debug", "lib/base/1.1.1/base-debug", "lib/class/1.1.0/class-debug", "lib/events/1.1.0/events-debug", "lib/overlay/1.1.4/mask-debug", "lib/templatable/0.9.1/templatable-debug", "gallery/handlebars/1.0.2/handlebars-debug", "./dialog-debug.handlebars", "./confirmbox-debug.handlebars", "./dialog-debug.css" ], function(require, exports, module) {
    ...
    module.exports.outerBoxClass = "lib-dialog-1_2_5";
});

define("lib/dialog/1.2.5/dialog-debug", [ "$-debug", "lib/overlay/1.1.4/overlay-debug", "lib/position/1.0.1/position-debug", "lib/iframe-shim/1.0.2/iframe-shim-debug", "lib/widget/1.1.1/widget-debug", "lib/base/1.1.1/base-debug", "lib/class/1.1.0/class-debug", "lib/events/1.1.0/events-debug", "lib/overlay/1.1.4/mask-debug", "lib/templatable/0.9.1/templatable-debug", "gallery/handlebars/1.0.2/handlebars-debug" ], function(require, exports, module) {
    var $ = require("$-debug"), Overlay = require("lib/overlay/1.1.4/overlay-debug"), mask = require("lib/overlay/1.1.4/mask-debug"), Events = require("lib/events/1.1.0/events-debug"), Templatable = require("lib/templatable/0.9.1/templatable-debug");
    // Dialog
    // ---
    ...
    var Dialog = Overlay.extend({
        ...
        attrs: {
            // 模板
            template: require("lib/dialog/1.2.5/dialog-debug.handlebars"),
            // 对话框触发点
            trigger: {
                value: null,
                getter: function(val) {
...
define("lib/dialog/1.2.5/dialog-debug.handlebars", [ "gallery/handlebars/1.0.2/runtime-debug" ], function(require, exports, module) {
...
define("lib/dialog/1.2.5/confirmbox-debug.handlebars", [ "gallery/handlebars/1.0.2/runtime-debug" ], function(require, exports, module) {
    var Handlebars = require("gallery/handlebars/1.0.2/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [ 3, ">= 1.0.0-rc.4" ];
