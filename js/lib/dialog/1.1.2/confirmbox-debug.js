define("lib/dialog/1.1.2/confirmbox-debug", [ "$-debug", "./dialog-debug", "lib/overlay/1.1.1/overlay-debug", "lib/position/1.0.1/position-debug", "lib/iframe-shim/1.0.2/iframe-shim-debug", "lib/widget/1.1.1/widget-debug", "lib/base/1.1.1/base-debug", "lib/class/1.1.0/class-debug", "lib/events/1.1.0/events-debug", "lib/overlay/1.1.1/mask-debug", "lib/templatable/0.9.1/templatable-debug", "gallery/handlebars/1.0.2/handlebars-debug", "./dialog-debug.handlebars", "./confirmbox-debug.handlebars", "./dialog-debug.css" ], function(require, exports, module) {
    ...
    module.exports.outerBoxClass = "lib-dialog-1_1_2";
});

define("lib/dialog/1.1.2/dialog-debug", [ "$-debug", "lib/overlay/1.1.1/overlay-debug", "lib/position/1.0.1/position-debug", "lib/iframe-shim/1.0.2/iframe-shim-debug", "lib/widget/1.1.1/widget-debug", "lib/base/1.1.1/base-debug", "lib/class/1.1.0/class-debug", "lib/events/1.1.0/events-debug", "lib/overlay/1.1.1/mask-debug", "lib/templatable/0.9.1/templatable-debug", "gallery/handlebars/1.0.2/handlebars-debug" ], function(require, exports, module) {
    var $ = require("$-debug"), Overlay = require("lib/overlay/1.1.1/overlay-debug"), mask = require("lib/overlay/1.1.1/mask-debug"), Events = require("lib/events/1.1.0/events-debug"), Templatable = require("lib/templatable/0.9.1/templatable-debug"), DEFAULT_HEIGHT = "300px";
    // Dialog
    // ---
    ...
    var Dialog = Overlay.extend({
        ...
        attrs: {
            // 模板
            template: require("lib/dialog/1.1.2/dialog-debug.handlebars"),
            // 对话框触发点
            trigger: {
                value: null,
                getter: function(val) {
...
define("lib/dialog/1.1.2/dialog-debug.handlebars", [ "gallery/handlebars/1.0.2/runtime-debug" ], function(require, exports, module) {
...
define("lib/dialog/1.1.2/confirmbox-debug.handlebars", [ "gallery/handlebars/1.0.2/runtime-debug" ], function(require, exports, module) {
    var Handlebars = require("gallery/handlebars/1.0.2/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [ 3, ">= 1.0.0-rc.4" ];
...
define("lib/dialog/1.1.2/dialog-debug.css", [], function() {
    seajs.importStyle(".lib-dialog-1_1_2 .ui-dialog{background-color:rgba(0,0,0,.5);border:0;FILTER:progid:DXImageTransform.Microsoft.Gradient(startColorstr=#88000000, endColorstr=#88000000);padding:6px}.lib-dialog-1_1_2 :root .ui-dialog{FILTER:none\\9}.lib-dialog-1_1_2 .ui-dialog-close{color:#999;cursor:pointer;display:block;font-family:tahoma;font-size:24px;font-weight:700;height:18px;line-height:14px;position:absolute;right:16px;text-decoration:none;top:16px;z-index:10}.lib-dialog-1_1_2 .ui-dialog-close:hover{color:#666;text-shadow:0 0 2px #aaa}.lib-dialog-1_1_2 .ui-dialog-title{height:45px;font-size:16px;font-family:'微软雅黑','黑体',Arial;line-height:46px;border-bottom:1px solid #E1E1E1;color:#4d4d4d;text-indent:20px;background:-webkit-gradient(linear,left top,left bottom,from(#fcfcfc),to(#f9f9f9));background:-moz-linear-gradient(top,#fcfcfc,#f9f9f9);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#fcfcfc', endColorstr='#f9f9f9');background:-o-linear-gradient(top,#fcfcfc,#f9f9f9);background:linear-gradient(top,#fcfcfc,#f9f9f9)}.lib-dialog-1_1_2 .ui-dialog-container{padding:15px 20px 20px;font-size:12px}.lib-dialog-1_1_2 .ui-dialog-message{margin-bottom:15px}.lib-dialog-1_1_2 .ui-dialog-operation{zoom:1}.lib-dialog-1_1_2 .ui-dialog-confirm,.lib-dialog-1_1_2 .ui-dialog-cancel{display:inline}.lib-dialog-1_1_2 .ui-dialog-operation .ui-dialog-confirm{margin-right:4px}.lib-dialog-1_1_2 .ui-dialog-button-orange,.lib-dialog-1_1_2 .ui-dialog-button-white{display:inline-block;*display:inline;*zoom:1;text-align:center;text-decoration:none;vertical-align:middle;cursor:pointer;font-size:12px;font-weight:700;border-radius:2px;padding:0 12px;line-height:23px;height:23px;*overflow:visible;background-image:none}.lib-dialog-1_1_2 a.ui-dialog-button-orange:hover,.lib-dialog-1_1_2 a.ui-dialog-button-white:hover{text-decoration:none}.lib-dialog-1_1_2 .ui-dialog-button-orange{color:#fff;border:1px solid #d66500;background-color:#f57403}.lib-dialog-1_1_2 .ui-dialog-button-orange:hover{background-color:#fb8318}.lib-dialog-1_1_2 .ui-dialog-button-white{border:1px solid #afafaf;background-color:#f3f3f3;color:#777}.lib-dialog-1_1_2 .ui-dialog-button-white:hover{border:1px solid #8e8e8e;background-color:#fcfbfb;color:#676d70}");
});
