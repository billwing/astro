define("lib/iframe-shim/1.0.0/iframe-shim-debug", ["$-debug", "lib/position/1.0.0/position-debug"], function(require, exports, module) {

    var $ = require('$-debug');
    var Position = require('lib/position/1.0.0/position-debug');
