define("lib/tip/1.1.2/atip-debug", [ "$-debug", "./tip-debug", "lib/popup/1.1.0/popup-debug", "lib/overlay/1.1.0/overlay-debug", "lib/position/1.0.1/position-debug", "lib/iframe-shim/1.0.2/iframe-shim-debug", "lib/position/1.0.0/position-debug", "lib/widget/1.1.0/widget-debug", "lib/base/1.1.0/base-debug", "lib/class/1.1.0/class-debug", "lib/events/1.1.0/events-debug", "./atip-debug.tpl" ], function(require, exports, module) {
    var $ = require("$-debug");
...
define("lib/tip/1.1.2/tip-debug", [ "lib/popup/1.1.0/popup-debug", "$-debug", "lib/overlay/1.1.0/overlay-debug", "lib/position/1.0.1/position-debug", "lib/iframe-shim/1.0.2/iframe-shim-debug", "lib/position/1.0.0/position-debug", "lib/widget/1.1.0/widget-debug", "lib/base/1.1.0/base-debug", "lib/class/1.1.0/class-debug", "lib/events/1.1.0/events-debug" ], function(require, exports, module) {
    var Popup = require("lib/popup/1.1.0/popup-debug");
    // 通用提示组件
    // 兼容站内各类样式
...
define("lib/tip/1.1.2/atip-debug.tpl", [], '<div class="ui-poptip">\n    <div class="ui-poptip-shadow">\n    <div class="ui-poptip-container">\n        <div class="ui-poptip-arrow">\n            <em>◆</em>\n            <span>◆</span>\n        </div>\n        <div class="ui-poptip-content" data-role="content">\n        </div>\n    </div>\n    </div>\n</div>\n\n');
