...
define("lib/calendar/0.9.0/base-calendar-debug", [ "$-debug", "lib/position/1.0.1/position-debug", "gallery/moment/2.0.0/moment-debug", "lib/widget/1.1.1/widget-debug", "lib/base/1.1.1/base-debug", "lib/class/1.1.0/class-debug", "lib/events/1.1.0/events-debug", "lib/iframe-shim/1.0.2/iframe-shim-debug", "lib/calendar/0.9.0/i18n/zh-cn-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    ...
    var lang = require("lib/calendar/0.9.0/i18n/zh-cn-debug") || {};
...
define("lib/calendar/0.9.0/i18n/zh-cn-debug", [], {
    Su: "日",
    Mo: "一",
    Tu: "二",
    We: "三",
...
define("lib/calendar/0.9.0/date-column-debug", [ "$-debug", "gallery/moment/2.0.0/moment-debug", "lib/calendar/0.9.0/base-column-debug", "lib/widget/1.1.1/widget-debug", "lib/base/1.1.1/base-debug", "lib/class/1.1.0/class-debug", "lib/events/1.1.0/events-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    var moment = require("gallery/moment/2.0.0/moment-debug");
    var BaseColumn = require("lib/calendar/0.9.0/base-column-debug");
...
define("lib/calendar/0.9.0/base-column-debug", [ "$-debug", "gallery/moment/2.0.0/moment-debug", "lib/widget/1.1.1/widget-debug", "lib/base/1.1.1/base-debug", "lib/class/1.1.0/class-debug", "lib/events/1.1.0/events-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    var moment = require("gallery/moment/2.0.0/moment-debug");
    var Widget = require("lib/widget/1.1.1/widget-debug");
...
define("lib/calendar/0.9.0/month-column-debug", [ "$-debug", "gallery/moment/2.0.0/moment-debug", "lib/calendar/0.9.0/base-column-debug", "lib/widget/1.1.1/widget-debug", "lib/base/1.1.1/base-debug", "lib/class/1.1.0/class-debug", "lib/events/1.1.0/events-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    var moment = require("gallery/moment/2.0.0/moment-debug");
    var BaseColumn = require("lib/calendar/0.9.0/base-column-debug");
...
define("lib/calendar/0.9.0/year-column-debug", [ "$-debug", "lib/calendar/0.9.0/base-column-debug", "gallery/moment/2.0.0/moment-debug", "lib/widget/1.1.1/widget-debug", "lib/base/1.1.1/base-debug", "lib/class/1.1.0/class-debug", "lib/events/1.1.0/events-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    var BaseColumn = require("lib/calendar/0.9.0/base-column-debug");
