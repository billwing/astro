define("lib/select/0.9.9/select-debug", [ "lib/overlay/1.1.4/overlay-debug", "$-debug", "lib/position/1.0.1/position-debug", "lib/iframe-shim/1.0.2/iframe-shim-debug", "lib/widget/1.1.1/widget-debug", "lib/base/1.1.1/base-debug", "lib/class/1.1.0/class-debug", "lib/events/1.1.0/events-debug", "lib/templatable/0.9.2/templatable-debug", "gallery/handlebars/1.0.2/handlebars-debug", "./select-debug.handlebars" ], function(require, exports, module) {
    var Overlay = require("lib/overlay/1.1.4/overlay-debug");
    var $ = require("$-debug");
    var Templatable = require("lib/templatable/0.9.2/templatable-debug");
    ...
    var Select = Overlay.extend({
        ...
        initAttrs: function(config, dataAttrsConfig) {
            ...
            if (trigger[0].tagName.toLowerCase() === "select") {
                ...
                // 隐藏原生控件
                // 不用 hide() 的原因是需要和 lib/validator 的 skipHidden 来配合
...
define("lib/select/0.9.9/select-debug.handlebars", [ "gallery/handlebars/1.0.2/runtime-debug" ], function(require, exports, module) {
