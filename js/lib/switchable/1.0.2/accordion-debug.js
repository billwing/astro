define("lib/switchable/1.0.2/accordion-debug", [ "./switchable-debug", "$-debug", "lib/widget/1.1.1/widget-debug", "lib/base/1.1.1/base-debug", "lib/class/1.1.0/class-debug", "lib/events/1.1.0/events-debug", "./plugins/effects-debug", "lib/easing/1.0.0/easing-debug", "./plugins/autoplay-debug", "./plugins/circular-debug" ], function(require, exports, module) {
...
define("lib/switchable/1.0.2/switchable-debug", [ "$-debug", "lib/widget/1.1.1/widget-debug", "lib/base/1.1.1/base-debug", "lib/class/1.1.0/class-debug", "lib/events/1.1.0/events-debug", "lib/switchable/1.0.2/plugins/effects-debug", "lib/easing/1.0.0/easing-debug", "lib/switchable/1.0.2/plugins/autoplay-debug", "lib/switchable/1.0.2/plugins/circular-debug" ], function(require, exports, module) {
    // Switchable
    // -----------
    ...
    var Effects = require("lib/switchable/1.0.2/plugins/effects-debug");
    var Autoplay = require("lib/switchable/1.0.2/plugins/autoplay-debug");
    var Circular = require("lib/switchable/1.0.2/plugins/circular-debug");
...
define("lib/switchable/1.0.2/plugins/effects-debug", [ "$-debug", "lib/easing/1.0.0/easing-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
...
define("lib/switchable/1.0.2/plugins/autoplay-debug", [ "$-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    var win = $(window);
    // 自动播放插件
    module.exports = {
...
define("lib/switchable/1.0.2/plugins/circular-debug", [ "$-debug", "lib/switchable/1.0.2/plugins/effects-debug", "lib/easing/1.0.0/easing-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    var SCROLLX = "scrollx";
    var SCROLLY = "scrolly";
    var Effects = require("lib/switchable/1.0.2/plugins/effects-debug").Effects;
    // 无缝循环滚动插件
    module.exports = {
        // 仅在开启滚动效果时需要
        isNeeded: function() {
