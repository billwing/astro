define("lib/validator/0.9.4/validator-debug", [ "./core-debug", "$-debug", "./async-debug", "lib/widget/1.1.1/widget-debug", "lib/base/1.1.1/base-debug", "lib/class/1.1.0/class-debug", "lib/events/1.1.0/events-debug", "./utils-debug", "./rule-debug", "./item-debug" ], function(require, exports, module) {
    var Core = require("./core-debug"), Widget = require("lib/widget/1.1.1/widget-debug"), $ = require("$-debug");
...
define("lib/validator/0.9.4/core-debug", [ "$-debug", "lib/validator/0.9.4/async-debug", "lib/widget/1.1.1/widget-debug", "lib/base/1.1.1/base-debug", "lib/class/1.1.0/class-debug", "lib/events/1.1.0/events-debug", "lib/validator/0.9.4/utils-debug", "lib/validator/0.9.4/rule-debug", "lib/validator/0.9.4/item-debug" ], function(require, exports, module) {
    var $ = require("$-debug"), async = require("lib/validator/0.9.4/async-debug"), Widget = require("lib/widget/1.1.1/widget-debug"), utils = require("lib/validator/0.9.4/utils-debug"), Item = require("lib/validator/0.9.4/item-debug");
    var validators = [];
    var setterConfig = {
        value: $.noop,
        setter: function(val) {
    ...
    var Core = Widget.extend({
        ...
        Statics: $.extend({
            helper: utils.helper
        }, require("lib/validator/0.9.4/rule-debug"), {
...
define("lib/validator/0.9.4/async-debug", [], function(require, exports, module) {
    var async = {};
...
define("lib/validator/0.9.4/utils-debug", [ "$-debug", "lib/validator/0.9.4/rule-debug" ], function(require, exports, module) {
    var $ = require("$-debug"), Rule = require("lib/validator/0.9.4/rule-debug");
    var u_count = 0;
    var helpers = {};
    function unique() {
...
define("lib/validator/0.9.4/rule-debug", [ "$-debug" ], function(require, exports, module) {
...
define("lib/validator/0.9.4/item-debug", [ "$-debug", "lib/validator/0.9.4/utils-debug", "lib/validator/0.9.4/rule-debug", "lib/widget/1.1.1/widget-debug", "lib/base/1.1.1/base-debug", "lib/class/1.1.0/class-debug", "lib/events/1.1.0/events-debug", "lib/validator/0.9.4/async-debug" ], function(require, exports, module) {
    var $ = require("$-debug"), utils = require("lib/validator/0.9.4/utils-debug"), Widget = require("lib/widget/1.1.1/widget-debug"), async = require("lib/validator/0.9.4/async-debug"), Rule = require("lib/validator/0.9.4/rule-debug");
    var setterConfig = {
        value: $.noop,
        setter: function(val) {
            return $.isFunction(val) ? val : utils.helper(val);
