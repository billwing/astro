define("lib/validator/0.9.5/validator-debug", [ "./core-debug", "$-debug", "./async-debug", "lib/widget/1.1.1/widget-debug", "lib/base/1.1.1/base-debug", "lib/class/1.1.0/class-debug", "lib/events/1.1.0/events-debug", "./utils-debug", "./rule-debug", "./item-debug" ], function(require, exports, module) {
...
define("lib/validator/0.9.5/core-debug", [ "$-debug", "lib/validator/0.9.5/async-debug", "lib/widget/1.1.1/widget-debug", "lib/base/1.1.1/base-debug", "lib/class/1.1.0/class-debug", "lib/events/1.1.0/events-debug", "lib/validator/0.9.5/utils-debug", "lib/validator/0.9.5/rule-debug", "lib/validator/0.9.5/item-debug" ], function(require, exports, module) {
    var $ = require("$-debug"), async = require("lib/validator/0.9.5/async-debug"), Widget = require("lib/widget/1.1.1/widget-debug"), utils = require("lib/validator/0.9.5/utils-debug"), Item = require("lib/validator/0.9.5/item-debug");
    var validators = [];
    var setterConfig = {
        value: $.noop,
        setter: function(val) {
    ...
    var Core = Widget.extend({
        ...
        Statics: $.extend({
            helper: utils.helper
        }, require("lib/validator/0.9.5/rule-debug"), {
