define("lib/validator/0.9.2/validator-debug", [ "./core-debug", "$-debug", "lib/widget/1.0.3/widget-debug", "lib/base/1.0.1/base-debug", "lib/class/1.0.0/class-debug", "lib/events/1.0.0/events-debug" ], function(require, exports, module) {
    var Core = require("./core-debug"), Widget = require("lib/widget/1.0.3/widget-debug"), $ = require("$-debug");
