...
define("lib/validator/0.9.2/async-debug", [], function(require, exports, module) {
    var async = {};
...
define("lib/validator/0.9.2/utils-debug", [ "./rule-debug", "./async-debug", "$-debug", "lib/widget/1.0.3/widget-debug", "lib/base/1.0.1/base-debug", "lib/class/1.0.0/class-debug", "lib/events/1.0.0/events-debug" ], function(require, exports, module) {
...
define("lib/validator/0.9.2/rule-debug", [ "./async-debug", "$-debug", "lib/widget/1.0.3/widget-debug", "lib/base/1.0.1/base-debug", "lib/class/1.0.0/class-debug", "lib/events/1.0.0/events-debug" ], function(require, exports, module) {
    var rules = {}, messages = {}, $ = require("$-debug"), async = require("./async-debug"), Widget = require("lib/widget/1.0.3/widget-debug");
...
define("lib/validator/0.9.2/item-debug", [ "./utils-debug", "./rule-debug", "./async-debug", "$-debug", "lib/widget/1.0.3/widget-debug", "lib/base/1.0.1/base-debug", "lib/class/1.0.0/class-debug", "lib/events/1.0.0/events-debug" ], function(require, exports, module) {
    var $ = require("$-debug"), utils = require("./utils-debug"), Widget = require("lib/widget/1.0.3/widget-debug"), async = require("./async-debug"), Rule = require("./rule-debug");
    var setterConfig = {
        value: function() {},
        setter: function(val) {
...
define("lib/validator/0.9.2/core-debug", [ "./async-debug", "./utils-debug", "./rule-debug", "./item-debug", "$-debug", "lib/widget/1.0.3/widget-debug", "lib/base/1.0.1/base-debug", "lib/class/1.0.0/class-debug", "lib/events/1.0.0/events-debug" ], function(require, exports, module) {
    var $ = require("$-debug"), async = require("./async-debug"), Widget = require("lib/widget/1.0.3/widget-debug"), utils = require("./utils-debug"), Item = require("./item-debug");
    var validators = [];
    var setterConfig = {
        value: function() {},
        setter: function(val) {
